const GlassCard = ({ children, className = "" }) => {
	return (
		<div
			className={`group relative rounded-2xl backdrop-blur-xl hover:shadow-gray-500/30 hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-1 active:scale-95 transition-all duration-500 ease-out cursor-pointer hover:border-green-400/60 overflow-hidden ${className}`}
		>
