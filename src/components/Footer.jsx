...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-muted to-muted/50 text-foreground pt-12 pb-6 px-4 sm:px-6 md:px-8">
      <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 border-b border-border pb-10">
          {/* Brand */}
          <div>
            <Logo />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link to="/" className="hover:text-base-content transition">
                  Home
                </Link>
              </li>
              <li>
